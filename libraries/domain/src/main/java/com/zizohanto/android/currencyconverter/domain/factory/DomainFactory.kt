package com.zizohanto.android.currencyconverter.domain.factory
...
object DomainFactory {
    ...
    fun getSymbols() = listOf("USD", "NGN")

    fun makeHistoricalData() =
        HistoricalData(convertedRate = 1759.0, timeStamp = 1606755566)

    fun makeHistoricalDataForPeriod(dates: List<String> = emptyList()): List<HistoricalData> {
        ...
        if (dates.isEmpty() || dates.size == 30) {
